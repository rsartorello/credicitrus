      ...
      <main className="flex-grow">
        ...
        <Faq
          ...
          items={[
            ...
            {
              question: "O que diferencia cada categoria (Gold, Platinum, Black, Zenith)?",
            ...
            },
            {
              ...
              answer: (
                <>
                  Você gerencia tudo pelo app: faturas, limites, cartão virtual, carteiras digitais e liberações de uso. - Para saber mais, acesse:{" "}
                  <a
                    href="http://www.sicoobcard.com.br/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="underline text-secondary hover:text-primary transition-colors"
                  >
                    http://www.sicoobcard.com.br/
                  </a>
                </>
              )
            }
