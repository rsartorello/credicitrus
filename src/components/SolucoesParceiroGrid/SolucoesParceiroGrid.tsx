...
const solucoes: SolucaoParceiro[] = [
  {
    id: 1,
    ...
    href: '/para-o-agronegocio/credito-rural',
  },
  {
    id: 2,
    ...
    href: '/para-o-agronegocio/consorcios',
  },
  {
    id: 3,
    ...
    href: '/para-o-agronegocio/seguro',
  },
  {
    id: 4,
...
export default function SolucoesParceiroGrid() {
    ...
    <section className="w-full bg-white py-16 md:py-24 lg:py-32 overflow-hidden">
      <div className="container mx-auto px-4 lg:px-8 xl:px-12 max-w-[1400px]">
        ...
        <div className="block md:hidden mb-20 relative px-2 pt-10">
          ...
          {/* Navegação Customizada Mobile (Igual a OutrasSolucoesGeral e GridEmprestimoPJ) */}
