...
const solucoes: SolucaoVoce[] = [
  {
    id: 1,
    icon: '/soltas/icone-emprestimos.svg',
    title: 'Empréstimos e Financiamento',
    description: 'Crédito sob medida para você realizar seus planos pessoais.',
    href: '/para-voce/emprestimos-e-financiamentos',
  },
  {
    id: 2,
    icon: '/soltas/icone-consorcio.svg',
    title: 'Consórcio',
    description: 'Planeje a conquista do seu carro, imóvel ou outros bens sem juros.',
    href: '/para-voce/consorcios',
  },
  {
    id: 3,
    icon: '/soltas/icone-investimentos.svg',
    title: 'Investimentos',
    description: 'Rentabilidade e segurança para fazer seu patrimônio render.',
  ...
  },
  {
    ...
    description: 'Cartões com benefícios exclusivos e programa de pontos.',
    href: '/para-voce/cartoes-de-credito',
  },
  {
    id: 5,
    icon: '/soltas/icone-seguro.svg',
    title: 'Seguros',
    description: 'Proteção para a sua vida, saúde, bens e tudo o que é importante.',
  ...
  },
  {
    ...
    href: '/para-voce/solucoes-de-recebimento',
  },
  {
    id: 7,
    icon: '/soltas/icone-credicitrusclub.svg',
    title: 'Credicitrus Club',
    description: 'Vantagens e descontos exclusivos em parceiros de diversos segmentos.',
    href: '/para-voce/credicitrus-club',
  },
  {
    id: 8,
    icon: '/soltas/icone-produtoseservicos.svg',
    title: '+ Produtos e Serviços',
    description: 'Descubra outras soluções financeiras feitas para você.',
    href: '/fale-com-a-gente',
  },
];

export default function SolucoesVoceGrid() {
      ...
      <div className="container mx-auto px-4 lg:px-8 xl:px-12 max-w-[1400px]">
        ...
        <div className="text-center mb-16 md:mb-20">
          ...
          <h2 className="text-primary font-extrabold text-3xl md:text-4xl lg:text-5xl xl:text-[3.25rem] leading-tight max-w-4xl mx-auto">
            A Credicitrus tem o produto ideal para você realizar seus planos
          </h2>
        </div>
